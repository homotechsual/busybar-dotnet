...
{
    /// <summary>Uploads a file to internal storage. Ownership of <paramref name="fileContent"/> transfers to this call; it is disposed once the upload completes.</summary>
    ...
    /// <summary>Downloads a file from internal storage.</summary>
    ...
    /// <summary>Lists the contents of a directory on internal storage.</summary>
    ...
    /// <summary>Removes a file from internal storage.</summary>
    ...
    /// <summary>Creates a new directory on internal storage.</summary>
    ...
    /// <summary>Renames or moves a file on internal storage.</summary>
    ...
    /// <summary>Gets internal storage usage.</summary>
